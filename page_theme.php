...
class PageTheme extends Theme implements ThemeProviderInterface
{
    ...
    public function getThemeEditorClasses()
    {
        return [
            ...
            ['title' => t('Subtle Link Airport'), 'menuClass' => '', 'spanClass' => 'subtle-link-airport', 'forceBlock' => '-1'],
            ...
            ['title' => t('Subtle Link Peters'), 'menuClass' => '', 'spanClass' => 'subtle-link-peters', 'forceBlock' => '-1'],

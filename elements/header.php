...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Exo+2:ital,wght@0,500;0,800;1,400;1|Open+Sans:300,400,600,700&display=swap" rel="stylesheet">
...
<body class="vibrant">
  ...
  <header class="header" class="header">
    ...
    <div class="navigation">
      <a href='/'>
      <img src="<?php echo $this->getThemePath(); ?>/images/vibrant-logo.png" alt="Vibrant Logo" class="logo"></a>
            <?php   

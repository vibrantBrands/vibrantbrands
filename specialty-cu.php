...
<div class="container">
   ...
   <div class="container">
        ...
        <div>
            <a href="<?php echo $this->getThemePath(); ?>/images/screenshots/inner-lakes.html" data-lity data-lity-desc="Northern">
                <img src="<?php echo $this->getThemePath(); ?>/images/case-studies/thumbnails/inner-lake.jpg" alt="Inner Lakes">
                <div class="info">
                    <div class="info-bg"></div>
